...
<body>
	...
	<div class="login-box">
		...
		<h1>DAFTAR PEMBUATAN KARTU VAKSIN</h1>

<form action="" method="post" enctype="multipart/form-data">

		<div class="NIK">
			<input type="text" placeholder="masukan No Nik anda !" name="nrp" value="" id="nrp">
			<i class="fa fa-user" aria-hidden="true"></i>
		</div>

		<div class="username">
			<input type="text" placeholder="masukan Nama lengkap!" name="nama" value="" id="nama">
			<i class="fa fa-address-card" aria-hidden="true"></i>
		</div>
		
		<div class="alamat">
			<input type="text" name="jurusan" id="jurusan" placeholder="Masukan Alamat Lengkap" required>
			<i class="fa fa-address-card" aria-hidden="true"></i>
		</div>
		...
		<button class="btn" type="submit" name="submit">Create Data</button>
